pipeline {
    parameters {
        string description: 'The project\'s name that will be used during the pipeline', name: 'PROJECT_NAME', trim: true, defaultValue: ''
        string description: 'The GitHub\'s repository address', name: 'REPOSITORY_ADDRESS', trim: true, defaultValue: ''
        string description: 'The branch that will be used during pipeline', name: 'BRANCH', trim: true, defaultValue: 'main'
        string description: 'The Dockerfile\'s relative path', name: 'DOCKERFILE_PATH', trim: true, defaultValue: ''
    }    
